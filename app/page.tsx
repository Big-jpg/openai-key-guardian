    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <div className="sticky top-0 z-20 border-b border-zinc-800/80 bg-zinc-950/70 backdrop-blur">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => mutate(`/api/metrics?limit=${METRICS_LIMIT}`)}
            ...
            {!running ? (
              <button
                onClick={() => runScan()}
                className="inline-flex items-center gap-2 rounded-xl border border-indigo-500 bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-500 active:scale-[0.98] transition"
              >
                Run scan
              </button>
            ) : (
              <button
                onClick={stopScan}
                className="inline-flex items-center gap-2 rounded-xl border border-rose-500 bg-rose-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-500 active:scale-[0.98] transition"
              >
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 space-y-6">
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/60 backdrop-blur p-6 shadow-lg shadow-black/20">
          ...
          {/* Fixed-height container so the whole app fits without page scroll */}
          <div className="h-[52vh] overflow-auto rounded-xl border border-zinc-800 shadow-inner shadow-black/20">
            <table className="w-full border-separate border-spacing-0 text-sm">
              <thead className="sticky top-0 bg-zinc-900/90 backdrop-blur">
                <tr>
                  ...
                  <th className="text-left px-3 py-2 border-b border-zinc-800 text-zinc-400">Date</th>
